...
namespace StarGazer.Explorer
{
    internal class Explorer
    {
        private IStarGazerCore ObservatoryCore;
        ...
        internal Explorer(ExplorerWorker explorerWorker, IStarGazerCore core, ObservableCollection<object> results)
        {
