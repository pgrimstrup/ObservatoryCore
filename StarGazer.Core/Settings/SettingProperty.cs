...
namespace StarGazer.Plugins
{
    public class SettingProperty : INotifyPropertyChanged
    {
        ...
        private SettingProperty(IObservatoryPlugin plugin, object settings, PropertyInfo property, SettingProperty previous)
        {
            ...
            var dependsOn = property.GetCustomAttribute<SettingDependsOnAttribute>();
            ...
            {
                var actionAttribute = property.GetCustomAttribute<SettingPluginActionAttribute>();
