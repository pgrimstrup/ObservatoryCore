...
namespace StarGazer.Framework.Interfaces
{
    ...
    /// <para>Note: Not intended to be implemented on its own and will not define a functional plugin. 
    /// Use IStarGazerWorker and/or IStarGazerNotifier as appropriate.</para>
    /// </summary>
    public interface IStarGazerPlugin : IObservatoryPlugin
    {
        /// <summary>
        /// <para>This method will be called on startup by StarGazer Core when a plugin is first loaded.</para>
        /// <para>Passes the Core interface to the plugin.</para>
        /// </summary>
        /// <param name="core">Object implementing StarGazer Core's main interface. A reference to this object should be maintained by the plugin for communication back to Core.</param>
        public Task LoadAsync(IStarGazerCore core);
    ...
    /// <summary>
    /// Interface passed by StarGazer Core to plugins. Primarily used for sending notifications and UI updates back to Core.
    /// </summary>
    public interface IStarGazerCore : IObservatoryCore
    {
        ...
        /// <summary>
        /// Send a notification with arguments out to all native notifiers and any plugins implementing IStarGazerNotifier and/or IObservatoryNotifier.
        /// </summary>
